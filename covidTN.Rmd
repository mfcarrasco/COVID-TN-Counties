...
tn_age$Census_Percent = round(age_census$Percent, 1)
tn_age$Census_Percent[10] = NA

tn_age = tn_age[,c('Age_Ranges', 'Case_Percent','Death_Percent','Census_Percent')] %>%
  tidyr::gather('Percent', 'Value', -Age_Ranges)

#Plot
fills = c('Case_Percent' = 'grey', 'Death_Percent' = '#CC0000', 'Census_Percent' = '#002D65')
ggplot(data=tn_age, aes(x=Age_Ranges, y = Value, fill=Percent))+
  ...
  theme(panel.background = element_blank(), 
        ...
        legend.position = 'top')+
  scale_fill_manual(values=fills, labels=c('Cases', 'Percent of Population', 'Deaths'))
```
...
tn_sex = dplyr::left_join(tn_sex[,c(1,3)], sex_census, 'Sex') %>%
  tidyr::gather('Percent', 'Value', -Sex)



fills = c('Case_Percent' = 'grey','Census_Percent' = '#002D65')
ggplot(data=tn_sex, aes(x=Sex, y = Value, fill=Percent))+
  geom_col(position='dodge')+
  xlab('')+
  ylab('Percent')+
  theme(panel.background = element_blank(), 
        ...
        legend.direction='horizontal',
        legend.position = 'top')+
  scale_fill_manual(values=fills, labels=c('Cases', 'Percent of Population'))
```
