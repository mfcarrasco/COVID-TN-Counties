...
ggplot(data=tn_top, aes(x=date, y=cases, color=county))+
  ...
  theme(legend.title = element_blank(), 
        ...
        axis.text.x = element_text(angle=45, hjust=1))+
  scale_color_brewer(palette = 'Spectral',direction=-1)+
  scale_y_log10(breaks=scales::trans_breaks('log10', function(x) 10^x))#+annotation_logticks()
...
### Positive cases by counties with more than 20 cases {.mobile}
...
### Change of New Cases in Tennessee
Previous 4 Weeks
