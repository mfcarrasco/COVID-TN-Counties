...
tn_age = tn_age[which(tn_age$Age_Ranges != 'Pending' & tn_age$Age_Ranges != 'Total'),]
...
ggplot(data=tn_age, aes(x=Age_Ranges, y=Count))+
  ...
  xlab('')+
  theme(panel.background = element_blank(), axis.line = element_line(), axis.text = element_text(face = 'bold'))
```
