...
```{r}
tn_ext[,c('COUNTY','CASES_CONFIRMED','ACTIVE_TOT', 'RECOV_TOT', 'HOSPITALIZED_TOT','DEATHS_TOT')] %>%
  DT::datatable(rownames = FALSE,
                colnames = c('County','Confirmed', 'Active','Recovered', 'Hospitalized', 'Death'),
